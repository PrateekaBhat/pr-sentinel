- [PR Sentinel](#pr-sentinel)
  - [Why PR Sentinel?](#why-pr-sentinel)
  - [At a glance](#at-a-glance)
  - [Architecture](#architecture)
  - [How decisions are made](#how-decisions-are-made)
    - [Deterministic layer](#deterministic-layer)
    - [AI layer](#ai-layer)
  - [RAG: how repository context works](#rag-how-repository-context-works)
  - [LangGraph and specialist routing](#langgraph-and-specialist-routing)
    - [Implementation details: ranking, validation, and the judge's conflict rule](#implementation-details-ranking-validation-and-the-judges-conflict-rule)
  - [Context bounding and large PRs](#context-bounding-and-large-prs)
  - [LLM providers](#llm-providers)
    - [Ollama](#ollama)
    - [Hosted providers](#hosted-providers)
  - [AI failure and fallback behavior](#ai-failure-and-fallback-behavior)
  - [Example analysis lifecycle](#example-analysis-lifecycle)
  - [CLI](#cli)
  - [Dashboard](#dashboard)
